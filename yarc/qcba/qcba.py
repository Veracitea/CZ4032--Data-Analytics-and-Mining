...
class QCBA:
    ...
    def __init__(self, quantitative_dataset, cba_rule_model=None, rules=None):
        ...
        if cba_rule_model:
            self.__quant_rules = [ QuantitativeCAR(r) for r in cba_rule_model.pre.rules ]
        if rules:
    ...
    def fit(
        ...
        self.pre = QuantitativeClassifier(transformed_rules, default_class)
    ...
    def score(self, quantitative_dataset):
        ...
        return self.pre.rule_model_accuracy(quantitative_dataset, actual)
